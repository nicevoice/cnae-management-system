...
module.exports = testCase({
  setUp:function(cb){
    ...
    req.params.id = "unit22";
    req.url = "/application/mamage/unit22/vermng";
  ...
  tearDown:function(cb){
    ...
    testEvent.once("testNow", function(data){
      test.deepEqual(data, "/application/mamage/unit22/sum");
      test.done();
    })
  ...
  test_git_clone_wrong_url : function(test){
    ...
    testEvent.once("testNow", function(data){
      test.deepEqual(data, {status:"error", msg:"请输入正确的git-url"});
      test.done();
    });
  ...
  test_create_mongo : function(test){
    testEvent.once('testNow', function(data){
      test.deepEqual(data, '/application/mamage/unit22/mongo');
      test.done();
    })
  ...
  test_new_todo_null:function(test){
    testEvent.once('testNow', function(data){
      test.deepEqual(data, '/application/manage/unit22/todo');
      findOne(app_basic,{appDomain:'unit22'},function(err, result){
