...
LIBDIR = '/home/deadhorse/.node_libraries'
LIBPATH_ICONV = ['/usr/lib', '/usr/local/lib', '/usr/lib64']
LIBPATH_NODE = '/usr/local/lib'
LIBPATH_SSL = ['/usr/lib', '/usr/local/lib', '/usr/lib64']
LIBPATH_ST = '-L%s'
LIB_ICONV = ['iconv']
LIB_SSL = ['ssl']
LIB_ST = '-l%s'
...
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/home/deadhorse/.node_libraries'
PREFIX = '/usr/local'
